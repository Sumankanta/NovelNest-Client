...
const Signup = () => {
    ...
    return (
        <div className="h-screen flex overflow-hidden relative">
            ...
            <div className={`flex md:w-1/2 justify-center py-10 items-center bg-white transition-transform duration-500 bg-gradient-to-l from-gray-200 via-fuchsia-200 to-stone-100 ${isVisible ? 'translate-x-0' : 'translate-x-full'}`}>
                <form onSubmit={handleSignup} className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl transition-all duration-300 ease-in-out hover:border-indigo-500 focus-within:border-indigo-500">
                    ...
                    <p className="mt-4 mb-4">If you don't have an account, please <Link to="/login" className="text-blue-600 underline">Login</Link> here.</p>
                    <button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 transition-all duration-300 ease-in-out transform hover:scale-105">Sign Up</button>
                    ...
                    <div className="mt-4 grid space-y-4">
                        <button onClick={handleRegister} className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                            <div className="relative flex items-center space-x-4 justify-center">
                                <img src="https://img.icons8.com/?size=100&id=V5cGWnc9R4xj&format=png&color=000000" className="absolute left-0 w-5" alt="google logo" />
...
//                         <input className="pl-2 outline-none border-none" type="password" name="password" id="password" placeholder="Password" />
//                     </div>
//                     <p className=' mt-4 mb-4'>If you don't have an account, please <a href="/login" className="text-blue-600 underline">Login</a> here.</p>
...
//                                 </div>
//                                 <p>If you have't an account, please <Link to="/login" className='text-blue-600 underline'>Login</Link> here.</p>
//                                 <div className="relative">
